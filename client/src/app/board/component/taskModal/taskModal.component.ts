import { Component, HostBinding, OnDestroy,  ViewChild, ElementRef } from '@angular/core';
    ...
    combineLatest([this.task$, this.columnForm.get('columnId')!.valueChanges])
      ...
      .subscribe(([task, columnId]) => {
        if (task.columnId !== columnId) {
          this.tasksService.updateTask(this.boardId, task.id, { columnId: columnId as any });
        }
      });
